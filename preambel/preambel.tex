...
%Some shortcuts
\newcommand{\LA}{$\Lambda(1405)$}
\newcommand{\SP}{$\Sigma(1385)^+$}
...
%%% Koerper Groesse
   ...
   lines=60,       % enables users to specify \textheight by the number of lines.
...
%%% Margin
   ...
   top=3.5cm,         % top margin of the page.
                  % Alias : tmargin
   bottom=3.2cm,      % bottom margin of the page
                  % Alias : bmargin
   ...
   bindingoffset=12mm,  % removes a specified space for binding 15mm
%%% Dimensionen
   ...
   %twoside,
   textwidth=460pt,   % sets \textwidth directly   430
...
%\newcommand\SectionFontStyle{\rmfamily}
\newcommand\SectionFontStyle{\bfseries\rmfamily}
